	...
	<div class="banner-text"/>
		...
		<?php 
                ...
                while($row = $result->fetch_assoc()){
                    echo"
					<a href='forbooks/index.php?category_id=$row[id]'><span></span>$row[category_name]</a>
                    ";
                }
                ?>
		</div>
...
<div class="inquiries-box">
	<div class="inquiries">
		...
		<div class="inquiries-desc">
			<div class="inquiries-icon">
				<a href="signup.php"> <i class="fa fa-sign-in"></i> </a>
			</div>
			<div class="inquiries-text">
				<p> Finally! Sign up feature is already available.
				    Click the icon to sign up or go to homepage and click the sign up button 
			        to be able to add your books in J-LIB. </p>
			</div>
		</div>
