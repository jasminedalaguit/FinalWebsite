...
<section id="banner"/>
	...
	<div class="banner-text"/>
		...
		<div class="banner-btn"/> 
			...
			<a href="romance/index.html"/><span></span> ROMANCE </a>
			<a href="fantasy/index.html"/><span></span> FANTASY </a>
			<a href="suspense/index.html"/><span></span> SUSPENSE </a>
			<a href="horror/index.html"/><span></span> HORROR </a>
		</div>
	</div>
</section>
...
<div id="menuBtn">
	<a href="form.php"> <button> SIGN UP </button> </a>
...
<div class="inquiries-box">
	<div class="inquiries">
		...
		<div class="inquiries-desc">
			<div class="inquiries-icon">
				<a href="form.php" i class="fa fa-sign-in"></i></a> 
			</div>
			<div class="inquiries-text">
				<p> Finally! The sign-up feature is already available. Click the icon to create an account and be able to share your own stories and books. </p>
			</div>
		</div>
